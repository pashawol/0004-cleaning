      ...
      <footer class="footer block-with-lazy">
        <div class="container">
          ...
          <div class="footer__foot">
            <div class="row">
              <div class="footer__foot-col col-lg-auto"><a class="small text-secondary tdu" href="#" target="__blank">Политика конфиденциальности</a>
              </div>
              <div class="footer__foot-col col-lg"><a class="small text-secondary tdu" href="#" target="__blank">Пользовательское соглашение</a>
              </div>
